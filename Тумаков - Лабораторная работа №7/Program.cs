            ...
            do
            {
                ...
                switch (taskNumber)
                {
                    case "1":
                        ...
                        BankAccountEx1 firstBankAccount = new BankAccountEx1(523, 1000000, BankAccountEx1.AccountType.Текущий_счет);

                        firstBankAccount.AccountNumber = 678;
                        firstBankAccount.AccountBalance = 900000;
                        firstBankAccount.BankAccountType = BankAccountEx1.AccountType.Сберегательный_счет;
                    ...
                    case "2":
                        ...
                        BankAccountEx2 secondBankAccount = new BankAccountEx2(1000000, BankAccountEx2.AccountType.Текущий_счет);
                        BankAccountEx2 thirdBankAccount = new BankAccountEx2(1000, BankAccountEx2.AccountType.Сберегательный_счет);
                    ...
                    case "3":
                        ...
                        bool withdrawResult;
                        BankAccountEx3 fourthBankAccount = new BankAccountEx3(BankAccountEx3.AccountType.Сберегательный_счет);
